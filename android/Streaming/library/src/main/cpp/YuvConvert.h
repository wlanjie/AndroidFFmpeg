...
public:
    ...
    char* nv21_convert_i420(char *nv21, int width, int height, bool need_flip, int rotate_degree);
    char* nv21_convert_nv12(char *nv21, int width, int height, bool need_flip, int rotate_degree);
private:
