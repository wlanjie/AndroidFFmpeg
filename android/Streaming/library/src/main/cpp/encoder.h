...
bool convert_to_i420(jbyte *src_frame, jint src_width, jint src_height, jboolean need_flip, jint rotate_degree, int format);
...
jbyteArray encoderNV21ToI420(JNIEnv *env, signed char *nv21_frame, int src_width, int src_height, unsigned char need_flip, int rotate_degree);
jbyteArray NV21ToNV12(JNIEnv* env, signed char *nv21_frame, int src_width, int src_height, unsigned char need_flip, int rotate_degree);
