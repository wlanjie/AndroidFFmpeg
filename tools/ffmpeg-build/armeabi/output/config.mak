...
OBJCFLAGS=  
ASFLAGS=  -O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/Users/wlanjie/Documents/FFmpeg/tools/x264-build/armeabi/output/include -march=armv5te -mtune=arm9tdmi -msoft-float -march=armv5te -fPIC
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS= -L/Users/wlanjie/Documents/FFmpeg/tools/x264-build/armeabi/output/lib -lx264  -march=armv5te -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
